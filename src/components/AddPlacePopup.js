...
function AddPlacePopup({ isOpen, onClose, onAddPlaceSubmit, isLoading, startLoading, inputValidity, checkValidity }) {
  ...
  return (
    <PopupWithForm name="add" title="New place" isOpen={isOpen} onClose={onClose} buttonText={"Create"} loadingText={"Saving.."} isLoading={isLoading} onSubmit={handleSubmit} inputValidity={inputValidity}>
